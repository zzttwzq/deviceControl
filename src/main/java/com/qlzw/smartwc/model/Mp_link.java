...
public class Mp_link {
    ...
    public Mp_link(Long id,Integer parent_admin_id,Integer area_id,Integer mp_id,Integer status,Timestamp create_at,Timestamp update_at,Timestamp delete_at) {
        this.id=id;
