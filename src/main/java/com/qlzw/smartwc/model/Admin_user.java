...
public class Admin_user {
    ...
    public Admin_user(Long id,String name,String nick_name,String admin_token,String api_token,String email,Integer role_id,Integer area_id,Integer province_code,Integer city_code,Integer section_code,Integer is_single,String password,Timestamp create_at,Timestamp update_at,Timestamp delete_at) {
        this.id=id;
        this.name=name;
