...
public class Mp_user {
    ...
    public Mp_user(Long id,String name,String nick_name,String token,String open_id,String address,String city_name,Integer mobile,String cover,Integer share,Integer sex,String email,Integer admin_user_id,String password,Timestamp create_at,Timestamp update_at,Timestamp delete_at) {
        this.id=id;
        this.name=name;
