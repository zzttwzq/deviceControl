...
public class Dev_version {
    ...
    public Dev_version(Long id,String soft_version,String hard_version,String file_path,Integer status,Timestamp create_at,Timestamp update_at,Timestamp delete_at) {
        this.id=id;
