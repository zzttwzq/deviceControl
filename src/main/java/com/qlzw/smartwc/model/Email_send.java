...
public class Email_send {
    ...
    public Email_send(Long id,Integer send_user_id,String snno,String to_email,String subject,String message,String alarmnumber,Integer status,Timestamp create_at,Timestamp update_at,Timestamp delete_at) {
        this.id=id;
