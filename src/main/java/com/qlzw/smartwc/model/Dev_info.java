...
public class Dev_info {
    ...
    private Timestamp last_time; // 最后更新时间 
    ...
    public Dev_info(Long id,Integer dev_id,Timestamp last_time,Integer status,String snno,String ccid,String rfid,String proportion,Float temperature,Integer humidity,Float nh3,Integer dayon,Integer dayoff,Integer nighton,Integer nightoff,Integer addwaternum,Integer addwatertime,Integer atomizerpwm,Integer fanmin,Integer fanmax,Float totaladdwater,String alarmnumber,String rfid_status,String hrev,String srev,Timestamp create_at,Timestamp update_at,Timestamp delete_at) {
        this.id=id;
        this.dev_id=dev_id;
    ...
    public Timestamp getLast_time () { return this.last_time;}
    ...
    public void setLast_time (Timestamp last_time) { this.last_time = last_time;}
