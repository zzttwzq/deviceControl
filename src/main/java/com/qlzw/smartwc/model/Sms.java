...
public class Sms {
    ...
    public Sms(Long id,Integer user_id,String phone,Integer type,Integer status,String code,String snno,String dev_name,String alarm,Timestamp create_at,Timestamp update_at,Timestamp delete_at) {
        this.id=id;
