...
public class Role {
    ...
    public Role(Long id,String name,Integer edit_admin_user,Integer edit_mp_user,Integer edit_role,Integer edit_area,Integer edit_device,Integer edit_rfid,Timestamp create_at,Timestamp update_at,Timestamp delete_at) {
        this.id=id;
        this.name=name;
