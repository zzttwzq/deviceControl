...
public class Admin_userProvider {
    ...
    public String getUserWithToken() {

        return "select * from cleaner.admin_user where cleaner.admin_user.admin_token = #{token} ";
    }
    ...
    public String insertOne(Admin_user admin_user) {
        ...
        if (admin_user.getCreate_at() != null) {
           key += "create_at,";
           value += "#{create_at},";
        }

        if (admin_user.getUpdate_at() != null) {
           key += "update_at,";
           value += "#{update_at},";
        }
